...
//					BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_CYAN)));
        ...
        Submit.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
				...
				Log.d("ManoaBulletinBoard","length = " + length);
	...
	public Post storeViewToObject(){
		...
		Post UserPost = new Post(Title.getContext(), 1, Title.getText().toString(),
				"2014-11-15","02:55:00","03:55:00",Location_x,Location_y,"Post 208",Description.getText().toString(),Email.getText().toString(),num,Category.getSelectedItem().toString());
